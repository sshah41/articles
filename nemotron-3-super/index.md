...
![Table 1: Nemotron 3 Super Architectural Dimensions]({{ '/assets/table_1_architecture.png' | relative_url }})
...
![Nemotron 3 Super Layer Pattern]({{ '/assets/figure_2_layer_pattern.png' | relative_url }})
...
* **Increase Batch Sizes:** Serve far more concurrent users on the same node without running out of memory.
* **Scale Multi-Agent Workloads:** Operate multiple independent agents (e.g., a massive code-review agent and a testing agent) sharing a common working state simultaneously on a single GPU.
* **Execute Looping Contexts:** Stack substantially longer reasoning chains in autonomous loops without forcing expensive CPU offloading or multi-node sharding.
...
![Figure 3: Standard MoE vs. LatentMoE]({{ '/assets/figure_3_latent_moe.png' | relative_url }})
...
![Figures 4 and 5: MTP Performance]({{ '/assets/figure_4_5_mtp.png' | relative_url }})
...
![NVFP4 training stability charts from NVIDIA Technical Report]({{ '/assets/nvfp4_stability.png' | relative_url }})
...
![Table 9: Comprehensive Evaluation Suite]({{ '/assets/table_9_comprehensive_eval.png' | relative_url }})
...
![Accuracy and Throughput comparison on key benchmarks]({{ '/assets/figure_1_benchmarks.png' | relative_url }})
